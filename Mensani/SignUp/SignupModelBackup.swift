...
//
//    func sendValues(name: String?, email: String?, password: String?, cpassword: String?, token : String?,sportsId : String? , teamId : String?, type : Int, controller: UIViewController) {
...
//        }
//
//        checkValidation(name: namee, email: emailAddress, password: passwordD, cpassword: cpasswordD, token : token! ,sports: sports, team: team, type: type, controller : controller)
//
//    }
//
//
//    func checkValidation(name: String, email: String, password: String, cpassword: String ,token : String,sports : String , team : String ,type : Int, controller : UIViewController)
//    {
//        print("validation")
//        if  name.count < 1
//        {
...
//        }
//        else if sports == "" && type == 1
//        {
//            delegate?.sendResponse(handleString:  LocalisationManager.localisedString("token"), emailOrPassword: 4)
//        }
//        else
//        {
//            if type == 0
//            {
//                otpAPICALL(email :email,token : "", type : 0 , controller : controller)
//            }
//            else
//            {
//                otpAPICALL(email :email, token : sports, type : 1, controller : controller)
//            }
////            loginAPICALL(email :email, password : password , name : name ,token : token,sportsId: sports, teamId: team ,controller : controller)
//        }
//    }
//
//    func otpAPICALL(email :String,token : String, type : Int ,controller : UIViewController)
//    {
